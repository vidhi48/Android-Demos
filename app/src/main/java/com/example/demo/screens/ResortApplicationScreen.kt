...
class ResortApplicationScreen : AppCompatActivity() {
    ...
    private fun setupViews() {
        ...
        val info1 = ResortInfo(
            AppCompatResources.getDrawable(this, R.drawable.resort)!!,
            "Villa Gaanok Komang",
            "$78",
            "4.9"
        )
        val info2 = ResortInfo(
            AppCompatResources.getDrawable(this, R.drawable.resort_image)!!,
            "Banny's Apartments",
            "$50",
            "5.0"
        )
        val info3 = ResortInfo(
            AppCompatResources.getDrawable(this, R.drawable.resort_image2)!!,
            "Villa Parttes Ubad",
            "$112",
            "4.8"
        )
        val info4 = ResortInfo(
            AppCompatResources.getDrawable(this, R.drawable.resort)!!,
            "Villa Gaanok Komang",
            "$78",
            "4.9"
