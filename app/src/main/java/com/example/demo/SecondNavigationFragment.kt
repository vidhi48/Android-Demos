 ...
 * Use the [SecondNavigationFragment.newInstance] factory method to
...
class SecondNavigationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondNavigationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondNavigationFragment().apply {
